            ...
            <div className="w-full md:w-1/2 md:px-3">
              <div className="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
                ...
                <p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
                  Our HelpDesk system makes it easier than ever to resolve technical issues, manage tickets, and provide solutions. 
  ...
  <div className="container items-center max-w-6xl px-8 mx-auto xl:px-5">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      <div className="flex flex-col items-center group">
        ...
        <h3 className="mt-4 text-xl font-semibold text-gray-900 group-hover:text-purple-600 transition-all duration-300 ease-in-out">Ticket Management</h3>
        <p className="mt-2 text-gray-500 text-center group-hover:text-gray-700 transition-all duration-300 ease-in-out">Create and manage support tickets easily, track progress, and ensure timely resolution.</p>
      </div>
